<h2><a href="https://leetcode.com/problems/game-of-nim/">1908. Game of Nim</a></h2><h3>Medium</h3><hr><div><p>Alice and Bob take turns playing a game with <strong>Alice starting first</strong>.</p>
...
<pre><strong>Input:</strong> piles = [1]
...
<pre><strong>Input:</strong> piles = [1,1]
...
<pre><strong>Input:</strong> piles = [1,2,3]
<strong>Output:</strong> false
<strong>Explanation:</strong> It can be proven that Bob will always win. One possible scenario is:
